...
import { getSettingValue, throwCalculatorError } from './functions';
...
export async function getEcd0(
  ...
  switch (STA) {
    ...
    case EnumSTA.NF_EN_1992_3_NA:
    case EnumSTA.BS_EN_1992_3_NA: {
      let eds1 = await getSettingValue(TYC, PropertyCode.EDS1);
      let eds2 = await getSettingValue(TYC, PropertyCode.EDS2);
      return (
        0.85 *
