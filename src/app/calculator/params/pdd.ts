import { EnumENT, EnumSTA, EnumSTD } from '../common/enums';
...
function getSg_D89(
  ...
  return (
    (((((mgG71 * (d - x)) / le) * KUNIT) / 1000000) * SCEC * LND ** 2) /
    LEFFD ** 2
  );
}
...
function getSj_D90(
  ...
  return (
    (((((mjG72 * (d - x)) / le) * KUNIT) / 1000000) * SCEC * LND ** 2) /
    LEFFD ** 2
  );
}
...
function getSp_D91(
  ...
  return (
    (((((mpG73 * (d - x)) / le) * KUNIT) / 1000000) * SCEC * LND ** 2) /
    LEFFD ** 2
  );
}
...
function getFgv_D109(
  ...
  return (
    ((((mgG71 * LEFFD ** 2) / (w21 * ev * 1000000 * lfgv)) * KUNIT * LND ** 4) /
      LEFFD ** 4) *
    100
  );
}
...
function getFji_D110(
  ...
  return (
    ((((mj * LEFFD ** 2) / (w21 * ei * 1000000 * lfji)) * KUNIT * LND ** 4) /
      LEFFD ** 4) *
    100
  );
}
...
function getFpi_D111(
  ...
  return (
    ((((mpG73 * LEFFD ** 2) / (w21 * ei * 1000000 * lfpi)) * KUNIT * LND ** 4) /
      LEFFD ** 4) *
    100
  );
}
...
function getFgi_D112(
  ...
  return (
    ((((mgG71 * LEFFD ** 2) / (w21 * ei * 1000000 * lfgi)) * KUNIT * LND ** 4) /
      LEFFD ** 4) *
    100
  );
}
...
function getFjv_D113(
  ...
  return (
    ((((mjG72 * LEFFD ** 2) / (w21 * ev * 1000000 * lfjv)) * KUNIT * LND ** 4) /
      LEFFD ** 4) *
    100
  );
}
